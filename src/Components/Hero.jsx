    ...
    <div className='h-screen bg-[#0c4b54] text-center '>
        <div className=''>
            <div className='flex flex-col space-y-5 items-center justify-center p-10'>
                ...
                <h1 className='text-4xl lg:text-8xl md:text-5xl font-bold'>
                    Your Secure And 
                    {' '}
                ...
                <p className='text-xl font-thin tracking-wide'>Explore FinFuse today. Your finances: <br/>Discover FinFuse's Fintech Revolutions, Transforming Banking Experiences One Click at a Time.</p>
